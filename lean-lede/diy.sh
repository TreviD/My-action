...
curl -fsSL https://raw.githubusercontent.com/trevid/My-action/master/lean-lede/zzz-default-settings > package/lean/default-settings/files/zzz-default-settings
